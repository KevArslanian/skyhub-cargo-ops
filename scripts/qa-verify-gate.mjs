...
const STEPS = [
  ...
  { id: "dashboard-invariants", cmd: "node", args: ["scripts/qa-dashboard-invariants.mjs"], needsServer: false },
  { id: "dashboard-calm", cmd: "node", args: ["scripts/qa-dashboard-calm.mjs"], needsServer: true },
  { id: "dashboard-overlap", cmd: "node", args: ["scripts/qa-dashboard-overlap-check.mjs"], needsServer: true },
  { id: "feedback-surface", cmd: "node", args: ["scripts/qa-feedback-surface-check.mjs"], needsServer: false },
  { id: "datetime-format", cmd: "node", args: ["scripts/qa-datetime-format-check.mjs"], needsServer: false },
  { id: "datetime-unit", cmd: "node", args: ["scripts/test-format-datetime.mjs"], needsServer: false },
