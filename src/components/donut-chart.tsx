...
export function MiniDonutGroup({ charts, className }: MiniDonutGroupProps) {
  return (
    <div className={cn("grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3", className)}>
      {charts.map((chart) => (
        <div key={chart.title} className="flex flex-col items-center gap-3 rounded-[16px] border border-[color:var(--border-soft)] bg-[color:var(--panel-muted)]/60 px-3 py-3 xl:flex-row xl:items-center xl:gap-3">
